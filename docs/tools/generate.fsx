...
let referenceBinaries = [ "Ariadne.dll" ]
// Web site location for the generated documentation
let website = "/Ariadne"

let githubLink = "http://github.com/evelinag/Ariadne"

// Specify more information about your project
let info =
  [ "project-name", "Ariadne"
    "project-author", "Evelina Gabasova"
    "project-summary", "F# package for Gaussian process regression."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Ariadne" ]
